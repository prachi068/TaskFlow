...
const SORT_OPTIONS = [
  ...
  { id: "priority", label: "Priority", icon: <ListChecks className="w-4 h-4" /> },
];
...
const PendingPage = () => {
  ...
  return (
    <div
      className={`${layoutClasses.container} min-h-screen`}
      style={{ backgroundColor: "#F3E8FF" }}
    >
      {/* Header */}
      <div
        className={`${layoutClasses.headerWrapper} border-b border-gray-300 pb-4`}
      >
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 flex items-center gap-2 border-b border-gray-400 pb-2">
      ...
      >
        <div className="flex items-center justify-center gap-3 text-gray-700 group-hover:text-purple-600 transition-colors">
