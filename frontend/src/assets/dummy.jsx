...
export const menuItems = [
  ...
  { text: "Pending Tasks", path: "/pending", icon: ListChecks },
  { text: "Completed Tasks", path: "/complete", icon: CheckCircle2 },
];

// 🔹 Sort Options
export const SORT_OPTIONS = [
  { value: "high", label: "High Priority", icon: ArrowDownNarrowWide },
  { value: "low", label: "Low Priority", icon: ArrowUpNarrowWide },
];
...
export const securityFields = [
    { name: "current", placeholder: "Current Password",icon:Lock },
    { name: "new", placeholder: "New Password",icon:Lock },
    { name: "confirm", placeholder: "Confirm Password",icon:Lock },
];
